            ...
            <NoIncidentsContainer data-testid='welcome-view'>
                ...
                <NoIncidentsItem>
                    ...
                    <p className='mt-3 mb-8 light'>
                        {'Create a playbook to prescribe the workflow that your teams and tools should follow, including everything from checklists, triggers and actions, templates, and retrospectives.'}
                    </p>
                    <div className='header-button-div mb-4'>
                        <PrimaryButton
                            onClick={() => navigateToTeamPluginUrl(currentTeam.name, '/playbooks')}
